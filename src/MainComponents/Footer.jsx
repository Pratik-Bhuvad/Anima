    ...
    return (
        <div className=' w-[calc(100vw-17 px)] h-60 p-5 bg-[#2a2b2e] flex flex-col justify-between pb-1 *:mx-auto lg:h-44'>
            <div className="w-full h-4/5 flex flex-col-reverse items-center justify-between lg:flex-row lg:h-1/3">
                <section id="socialmedia" className='w-5/12 h-2/6 flex items-center justify-between px-3 *:rounded-xl *:bg-[#d9d9d91a] *:w-2/5 md:w-1/5 *:h-4/5 lg:*:h-full *:flex *:items-center *:justify-center lg:w-1/12 lg:h-full'>
                    <Link><i className="fa-brands fa-instagram fa-xl"></i></Link>
                    <Link><img src="/telegram.png" alt="" className='object-contain w-3/6 lg:w-4/6' /></Link>
                </section>
