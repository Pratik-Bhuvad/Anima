...
const Navbar = () => {
  ...
  return (
    <nav className='h-[3.5rem] w-screen bg-[rgba(42,43,46,0.8)] z-40 fixed top-0 flex items-center justify-between overflow-x-hidden md:h-[4.5rem] backdrop-blur-md box-border *:box-border'>
      <div className="profile w-full h-full flex items-center justify-evenly *:h-3/5 *:flex *:items-center lg:w-2/12">
        ...
        <span className='w-1/4 flex items-center justify-between lg:w-0'>
        ...
        { search &&
          <input type="text" name="" id="" className='w-[90vw] fixed left-5 top-16 text-xl rounded-sm p-1 px-3 border-2 border-white bg-transparent text-white lg:w-[30%] lg:top-[15px] lg:left-[20%]'/>
        }
      {show &&
        <div className='links w-9/12 h-[85vh] flex flex-col items-end fixed top-0 px-7 ease-in-out duration-500 lg:flex-row-reverse lg:items-center lg:h-[4.4rem] lg:w-5/12' style={{ right: `${show}%` }}>
