...
const Topshows = (props) => {
  return (
    <div className='w-full lg:h-[72vh] flex flex-col justify-between px-2 my-5 lg:px-12'>
      <div id="head" className='w-full flex items-center justify-between px-4'>
        <div>
          <View />
      ...
      <div className="w-full h-auto  md:h-[130vh] lg:h-[90%] p-5 pt-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 gap-y-7 items-center justify-center">
        {
